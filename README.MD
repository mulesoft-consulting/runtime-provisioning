...
The first section *Dockerizing the Mule Runtime EE* provides information about the Mule Runtime Dockerization.
...
* JDK Version: OpenJDK 8 (Docker Library)
